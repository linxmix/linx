...
extend(Stretch.prototype, {
    ...
    */
    ...
    process: function(sampleReq) {
        ...
        // this.sampleReq = this._inputBuffer.frameCount;
        // console.log("process begin", this._inputBuffer.frameCount, this.sampleReq);
        while (this._inputBuffer.frameCount >= this.sampleReq) {
            // console.log("process", this._inputBuffer.frameCount);
