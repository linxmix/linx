...
this["JST"]["library/Library"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div class="samples"></div>\n<div class="transitions"></div>';}return __p};
...
this["JST"]["library/samples/TransitionList"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div>\n  <p>add a new transition via drag n\' drop!</p>\n  <div class="drop"></div>\n</div>\n<ul class="list"></ul>\n';}return __p};
