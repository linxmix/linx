...
Utils = {
  ...
  // returns the composition of prev and next
  compose: function(prevFn, nextFn) {
    if (prevFn) {
      return function() {
        var result = prevFn.apply(this, arguments);
        return nextFn.call(this, result);
      };
    } else {
      return nextFn;
    }
  ...
  // returns the chaining of prev and next
  chain: function(prevFn, nextFn) {
    if (prevFn) {
      return function() {
